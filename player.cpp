...
void Mwindow::initUI() {
    ...
    QObject::connect(Open,    QAction::triggered, this, Mwindow::openFile);
    QObject::connect(playAc,  QAction::triggered, this, Mwindow::play);
    QObject::connect(aboutAc, QAction::triggered, this, Mwindow::about);
    QObject::connect(fsAc,    QAction::triggered, this, Mwindow::fullscreen);
    QObject::connect(Quit,    QAction::triggered, qApp, QApplication::quit);

    /* Buttons for the UI */
    playBut = new QPushButton("Play");
    QObject::connect(playBut, QPushButton::clicked, this, Mwindow::play);

    QPushButton *stopBut = new QPushButton("Stop");
    QObject::connect(stopBut, QPushButton::clicked, this, Mwindow::stop);

    QPushButton *muteBut = new QPushButton("Mute");
    QObject::connect(muteBut, QPushButton::clicked, this, Mwindow::mute);

    QPushButton *fsBut = new QPushButton("Fullscreen");
    QObject::connect(fsBut, QPushButton::clicked, this, Mwindow::fullscreen);

    volumeSlider = new QSlider(Qt::Horizontal);
    QObject::connect(volumeSlider, QSlider::sliderMoved, this, Mwindow::changeVolume);
    volumeSlider->setValue(80);

    slider = new QSlider(Qt::Horizontal);
    slider->setMaximum(1000);
    QObject::connect(slider, QSlider::sliderMoved, this, Mwindow::changePosition);

    /* A timer to update the sliders */
    QTimer *timer = new QTimer(this);
    QObject::connect(timer, QTimer::timeout, this, Mwindow::updateInterface);
    timer->start(100);
...
void Mwindow::openFile() {
    ...
    QString fileOpen = QDir::toNativeSeparators(QFileDialog::getOpenFileName(this, tr("Load a file"), "~"));
